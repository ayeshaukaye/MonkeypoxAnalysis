...
# tfidf = svc_pipe.named_steps['tfidf']
...
with st.expander("ℹ️ How to Read This ELI5 Explanation", expanded=False):
    st.markdown("""
...
# stress_posts = final_posts[final_posts["label"] == 1]
